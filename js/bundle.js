...
function sortTable(data, atribute, order) {
    ...
    if (atribute == name) {
        if (order == "asc") {
            var orderedNames = data.sort(function (a, b) {
                return a.firstName > b.firstName ? 1 : -1;
            });
            deletetBody();
            displayTable(orderedNames, false);
        } else {
            var reverseOrderedNames = data.sort(function (a, b) {
                return a.firstName > b.firstName ? -1 : 1;
            });
            deletetBody();
    ...
    if (atribute == "lname") {
        if (order == "asc") {
            var orderedLastNames = data.sort(function (a, b) {
                return a.lastName > b.lastName ? 1 : -1;
            });
            deletetBody();
            displayTable(orderedLastNames, false);
        } else {
            var reverseOrderedLastNames = data.sort(function (a, b) {
                return a.lastName > b.lastName ? -1 : 1;
            });
            deletetBody();
    ...
    if (atribute == "id") {
        if (order == "asc") {
            var orderedId = data.sort(function (a, b) {
                return a.id > b.id ? 1 : -1;
            });
            deletetBody();
            displayTable(orderedId, false);
        } else {
            var reverseOrderedId = data.sort(function (a, b) {
                return a.id > b.id ? -1 : 1;
            });
            deletetBody();
    ...
    if (atribute == "experience") {
        if (order == "asc") {
            var orderedExperience = data.sort(function (a, b) {
                return a.experience > b.experience ? 1 : -1;
            });
            deletetBody();
            displayTable(orderedExperience, false);
        } else {
            var reverseOrderedExperience = data.sort(function (a, b) {
                return a.experience > b.experience ? -1 : 1;
            });
            deletetBody();
    ...
    if (atribute == "function") {
        if (order == "asc") {
            var orderedFunction = data.sort(function (a, b) {
                return a.function > b.function ? 1 : -1;
            });
            deletetBody();
            displayTable(orderedFunction, false);
        } else {
            var reverseOrderedFunction = data.sort(function (a, b) {
                return a.function > b.function ? -1 : 1;
            });
            deletetBody();
